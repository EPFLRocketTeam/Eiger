    ...
    def __str__(self):
        ...
        for i in range(5):
            ...
            if i == 0:
                ...
                s = s + ", " + new
        time1 = int(str(self.DATA[5]))
        time2 = int(str(self.DATA[6]))
        time3 = int(str(self.DATA[7]))
        time_tot = time1 * 256 * 256 + time2 * 256 + time3
        s = s + ", " + str(time_tot) + "]"
        return s
...
if __name__ == '__main__':
    print("............STARTED.............")
    msg = TPCANMsg()
    data = 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00  # random values
    # lowest priority ID (max): 0x7FF
    msg._fields_ = [("ID", 0x7FF), ("MSGTYPE", PCAN_MESSAGE_STANDARD), ("LEN",    8), ("DATA", data)]
...
# _________________________________________________________________________________________________
        ...
        for wow in range(200000):
            ...
            if status == PCAN_ERROR_OK:
                ...
                #
                if wow % 10 == 0:
                    msg.setData([255, 255, 255, 255, 255, 255, 255, 255])
                    msg.setID(3)
